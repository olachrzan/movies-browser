...
export const apiUrlPopularMovies = `${apiUrl}movie/popular?api_key=${apiKey}`;
export const apiUrlSearchMovies = `${apiUrl}search/movie?&api_key=${apiKey}`
export const apiUrlPopularPeople = `${apiUrl}person/popular?api_key=${apiKey}`;
