...
export const apiUrlPopularMovies = `${apiUrl}movie/popular?api_key=${apiKey}&page=`; // popular movies
...
export const apiUrlPopularPeople = `${apiUrl}person/popular?api_key=${apiKey}&page=`; // popular people
